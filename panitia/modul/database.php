...
switch($_GET['aksi'])
{
case "ubahvertifikasi" : 
$cek=mysql_query("select status_vertifikasi from ppdb_data_siswa where no_peserta='$id'");
$rcek=mysql_fetch_array($cek);
if($rcek['status_vertifikasi']=="belum")
{
$q=mysql_query("update ppdb_data_siswa set status_vertifikasi='sudah' where no_peserta='$id'")or die(mysql_error());
}
else
{
$q=mysql_query("update ppdb_data_siswa set status_vertifikasi='belum' where no_peserta='$id'")or die(mysql_error());
}
header("location:../index.php?menu=calonsiswa");
break;
...
case "hapussiswa" : 
$q=mysql_query("delete from ppdb_data_siswa where no_peserta='$id'");
$q2=mysql_query("delete from ppdb_biodata where no_peserta='$id'");
header("location:../index.php?menu=calonsiswa");
break;
